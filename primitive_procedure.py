...
def newline():
    print
primitive_procedures = {"+":add, "-":sub, "*":mul, "/":div, "<":less,"=":equal,  "cons":cons, "car":car, "cdr":cdr, "set-car!": set_car, "set-cdr!": set_cdr, "eq?": equal, "null?": null, "pair?": pair,  "and":And, "or":Or, "not":Not, "atom?": atom, "length":length,"display":display, "newline":newline}
